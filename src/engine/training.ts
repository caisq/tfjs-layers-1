...
import {doc, io, Optimizer, Scalar, Tensor, Tensor1D, tensor1d, util} from '@tensorflow/tfjs-core';
...
import {LayerVariable, LossOrMetricFn, NamedTensorMap, Shape} from '../types';
